import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-TEYJ6RVN.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-PAY54OVR.js";
import {
  getStageColorByHex
} from "./chunk-XNW2MZPI.js";
import {
  LimitsModal,
  useReviewWorkflows
} from "./chunk-YHZ2YTLK.js";
import {
...
} from "./chunk-7X2FXAVV.js";
import {
  index
} from "./chunk-5I33D5QE.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-6CHLBZVN.js";
import {
  useConfig
} from "./chunk-FV6TQMO5.js";
import {
  useTracking
} from "./chunk-AYRGRGDS.js";
import {
  Drawer,
  abortUpload,
  cancelUpload,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-XULR4ME4.js";
import {
  pluginId
} from "./chunk-5QJFIL32.js";
import {
  useDocumentActions
} from "./chunk-LUYUW6Z5.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-OPMH4SB6.js";
import {
  renderAdmin,
  require_baseUniq,
  useDebounce
} from "./chunk-N6NAW25O.js";
import {
  useAIAvailability
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-4EE3JEQH.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
var admin = {
  ...
  register(app) {
    app.addSettingsLink({
      ...
      id: "settings",
      to: "email",
      Component: () => import("./Settings-L7ENV65J.js").then((mod) => ({
  ...
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: isBetaMediaLibrary ? () => {
        return import("./App-EQDVEYL3.js").then((mod) => ({
          default: mod.BetaMediaLibrary
        }));
      } : () => {
        return import("./App-OPBU6JMV.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    app.addSettingsLink("global", {
      ...
      Component() {
        return import("./SettingsPage-GDJHLVSK.js").then((mod) => ({
          default: mod.ProtectedSettingsPage
        }));
      },
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-OJ56H5TY.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-F6YXWPZ7.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./ReleasesSettingsPage-RFIWGCBT.js").then((mod) => ({
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-Q5T4AQSE.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./PurchaseContentReleases-2AYSCYEW.js").then((mod) => ({
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./router-24VKQUWA.js").then((mod) => ({
            default: mod.Router
          }));
        }
      });
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-V4NWLI2Y.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./purchase-review-workflows-YUIM6PWO.js").then((mod) => ({
...
//# sourceMappingURL=chunk-IWPQCXMH.js.map
