...
echo =========================================================
echo  1. Starting Strapi CMS Backend (Port 1338 / PostgreSQL)
echo =========================================================
start "1. Strapi Backend (Port 1338)" cmd /k "cd /d "%~dp0" && set "PATH=%USERPROFILE%\.config\herd\bin\nvm\v22.13.0;%PATH%" && npm run develop"
...
if exist "%~dp0dashboard\package.json" (
    echo =========================================================
    echo  3. Starting React Vite Business Dashboard (Port 5181)
    echo =========================================================
    start "3. React POS/CRM/ERP Dashboard (Port 5181)" cmd /k "cd /d "%~dp0dashboard" && set "PATH=%USERPROFILE%\.config\herd\bin\nvm\v22.13.0;%PATH%" && npm run dev"
)
