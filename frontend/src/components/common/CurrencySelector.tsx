    ...
    >
      ...
      >
        ...
        <span className="font-mono text-xs tracking-wider uppercase">
          {currentCurrency.code} <span className="text-[#c9a84c]">({currentCurrency.symbol})</span>
        </span>
        <ChevronDown 
          size={16} 
      ...
      {/* Luxury Custom Floating Dropdown Menu */}
      {isOpen && (
        <div className="absolute right-0 mt-2.5 w-60 rounded-2xl bg-[#090d16] border-2 border-[#c9a84c]/60 shadow-[0_20px_60px_rgba(0,0,0,0.95)] z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 text-white">
